                        ...
                        <div class="col-md-4">
                            <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-ticket"></i> Voucher Terpakai</div>
                                            <h2>1,111</h2>
                                        </div>
                        ...
                        <div class="card mt-5">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-5">
                                    <h4 class="header-title mb-0">Grafik Voucher Terklaim dan Terpakai</h4>
                                    <select class="custome-select border-0 pr-3">
                                        <option selected>7 Hari Terakhir</option>
                                        <option value="0">1 Bulan Terakhir</option>
                                    </select>
                                </div>
