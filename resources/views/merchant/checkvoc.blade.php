    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="{{route ('merchant.dashboard')}}"><img src="assets/auth/images/icon/logo.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="{{route ('merchant.checkvoc')}}" aria-expanded="true"><i class="fa fa-check-square-o"></i>
                ...
                <div class="col-sm-6 clearfix">
                                ...
                                <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Kumkum Rai <i class="fa fa-angle-down"></i></h4>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{route ('merchant.profil')}}">Profil</a>
                                        <a class="dropdown-item" href="{{route ('merchant.login')}}">Log Out</a>
                                    </div>
                                </div>
                            </div>
                </div>
                                        ...
                                        <table class="table table-hover progress-table text-center">
                                            <thead class="text-uppercase">
                                                <tr>
                                                    ...
                                                    <th scope="col">Sudah Pakai</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <th scope="row">Rani Anastasya</th>
                                                    <td>L 1234 AA</td>
                                                    <td>Samsat Surabaya</td>
                                                    <td>11/08/2023</td>
                                                    <td><a href="#" class="btn btn-primary btn-xs mb-3" data-toggle="modal" data-target="#exampleModalCenter">Lihat</a></td>
                                                    <td><button type="submit" class="btn btn-success btn-xs mb-3"><i class="fa fa-check"></i></button></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
