...
<head>
    ...
    <title>Admin JR - Voucher Berhasil Terklaim</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Voucher Berhasil Terklaim</h1>
                    <p class="mb-4">Berikut adalah daftar wajib pajak yang telah mengklaim voucher. untuk menambahkan merhant baru.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Voucher Berhasil Terklaim</h6>
                        </div>
                        <div class="card-body">
